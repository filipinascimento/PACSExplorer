...
class DensityGL {
	constructor(canvasElement) {
		...
		this.webgl_canvas = canvasElement;
		this.width = parseInt(this.webgl_canvas.width);
		this.height = parseInt(this.webgl_canvas.height);
	...
	initGL() {
		let context_name = "experimental-webgl"
		try {
			let attributes = {
				antialias: false,
				alpha: false
			};
			this.gl = this.webgl_canvas.getContext(context_name, attributes);
		} catch (e) {}
		if (!this.gl) {
